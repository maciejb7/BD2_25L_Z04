    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                if (isAuthenticated) {
                    const userPreferences = await matchPreferenceApi.getUserMatchPreferences();
                    setSelectedTypes(userPreferences.map((pref: UserMatchPreference) => pref.match_type_id));
                }
            } catch (error) {
